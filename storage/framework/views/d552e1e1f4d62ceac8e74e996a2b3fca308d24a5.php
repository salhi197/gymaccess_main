            ...
            <div class="row">
              <div class="col-12 col-sm-12 col-md-5 col-lg-5">
                <div class="card-header">
                      <div class="col--md-4">
                            <select class="js-example-basic-single" id="membre" name="membre">
                                <option value="0" >Aucun Membre</option>
                                    <?php $__currentLoopData = $membres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                         ...
                                         value="<?php echo e($membre->id); ?>"><?php echo e($membre->nom); ?> <?php echo e($membre->prenom); ?></option>
 ...
 -->                      </tbody>
              ...
              <div class="col-12 col-sm-12 col-md-7 col-lg-7">
                ...
                <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="col-6 col-sm-6 col-md-3 col-lg-3 mt-2 produitclass produitid<?php echo e($produit->id); ?>" >
                    <div class="card p-0 m-0">
                      <div class="card-body p-0 m-0 b-0" class="photo" id="<?php echo e($produit->id); ?>">
                        <img src="<?php echo e(asset('default.png')); ?>" alt="" class="img-thumbnail">
                      </div>
                      <div class="title">
                        <h2 class="names" id="<?php echo e($produit->id); ?>">
                      ...
                      <div class="card-footer cf">
                        <div class="row">
                          <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                            <span class="price">
                              <h3>
                              <?php echo e($produit->prix_vente ?? '0'); ?> DA 
                              </h3>

                              </span>
                          </div>
                          <div class="col-6 col-sm-6 col-md-6 col-lg-6 text-right">
                            <a href="#" class="btn btn-info btnadd" id="<?php echo e($produit->id ?? ''); ?>" >
                              <i class="fa fa-cart-plus" aria-hidden="true"></i>
                            </a>
                            <a href="#" class="btn btn-danger btnremove" id="<?php echo e($produit->id ?? ''); ?>"  >   
...
<script>
    ...
    $(document).ready(function() {
       ...
       const jsonObj = [
            <?php $__currentLoopData = $produits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                {numero:<?php echo json_decode($produit->id); ?>,name:'<?php echo e($produit->nom); ?>',prix:<?php echo json_decode($produit->prix_vente); ?>, qte: 0,max:<?php echo json_decode($produit->qte); ?>},
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       ]
       console.log(jsonObj)
