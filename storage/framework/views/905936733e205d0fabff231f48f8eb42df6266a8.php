                        <div class="modal fade" id="renouvler" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content model1">
                                    ...
                                    <div class="modal-header">
                                        <h5 class="modal-title text-danger" id="exampleModalLabel">Ce Membre a un montant à payer :<?php echo e($inscription->total-$inscription->versement); ?> DA</h5>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="modal-body">
                                        <form role="form" action="<?php echo e(route('inscription.store')); ?>" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="hidden" value="<?php echo e($membre->id ?? ''); ?>" name="membre2" />
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;">Nombre de mois</label>
                                                        <input type="number"  value="<?php echo e(old('nbrmois') ?? 1); ?>" min="1"  id="nbrmois2" name="nbrmois2" class="form-control">
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="debut2"  value="<?php echo e(Date('Y-m-d')); ?>" name="debut2" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="<?php echo e(old('remise') ?? 0); ?>" id="remise2" name="remise2" class="form-control">
                                                    </div>                                                    
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;">Total Final : </label>
                                                        <input type="number" value="<?php echo e(old('ttc') ?? 0); ?>" onkeydown="return false;" id="total2" name="total2" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;">Versement</label>
                                                        <input type="number"  value="<?php echo e(old('versement') ?? 0); ?>" id="versement2" name="versement2" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="m-0 text-white" style="font-size:30px;">Reste</label>
                                                        <input type="number"  value="<?php echo e(old('reste') ?? 0); ?>" onkeydown="return false;" id="reste2" name="reste2" class="form-control">
                                                    </div>                                                    
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
