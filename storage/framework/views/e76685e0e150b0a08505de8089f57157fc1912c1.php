...
<?php $__env->startSection('header'); ?>
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-info">
            <div class="inner">
                <h3><?php echo e(count($membres)); ?></h3>
                <p>Nombre Total</p>
            </div>
            <div class="icon">
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-success">
            <div class="inner">
                <h3><?php echo e(count($actifs)); ?></h3>
                <p>Total Actifs</p>
            </div>
            <div class="icon">
                <i class="ion ion-stats-bars"></i>
            </div>
            <a href="<?php echo e(route('membre.actifs')); ?>" class="small-box-footer">Plus d'info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
            <div class="inner">
                <h3><?php echo e(count($membres)-count($actifs)); ?></h3>
                <p>Total Expiré</p>
            </div>
            <div class="icon">
                <i class="ion ion-person-add"></i>
            </div>
            <a href="<?php echo e(route('membre.expirer')); ?>" class="small-box-footer">Plus d'info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-danger">
            <div class="inner">
                <h3><?php echo e(count($credits)); ?></h3>
                <p> Endettés </p>
            </div>
            <div class="icon">
                <i class="ion ion-pie-graph"></i>
            </div>
            <a href="<?php echo e(route('membre.credits')); ?>" class="small-box-footer">Plus d'info <i class="fas fa-arrow-circle-right"></i></a>
        </div>
    </div>
    ...
    <?php if(Auth::user()->isadmin == 1 and Auth::user()->genre=="mixte"): ?>
        <div class="row mb-2">
          <div class="col-sm-4">
...
<!--           <div class="col-sm-4">
              ...
              <h1 class="m-0 text-white"><a class="text-white" href="<?php echo e(route('membre.actifs')); ?>">Actifs : <?php echo e(count($actifs)); ?> </a> <h1>
              <h1 class="m-0 text-white"><a class="text-white" href="<?php echo e(route('membre.expirer')); ?>">Expiré : <?php echo e(count($membres)-count($actifs)); ?> </a> <h1>
              <h1 class="m-0 text-white"><a class="text-white" href="<?php echo e(route('membre.credits')); ?>">Endettés : <?php echo e(count($credits)); ?> </a> <h1>
          </div>
          <div class="col-sm-3">
              <h1 class="m-0 text-white">Crédit : <?php echo e($credit); ?>  DA<h1>
          </div>
 -->
        </div><!-- /.row -->
    <?php endif; ?>
        ...
        <div class="row mb-2">
        <?php if(Auth::user()->genre == "homme" and Auth::user()->isadmin !=1): ?>
        <div class="row mb-2">
          <div class="col-sm-4">
              <a href="<?php echo e(route('membre.create')); ?>" class="btn bubbly-button btn-lg"><i class="fa fa-plus"></i> Ajouter</a>
          </div><!-- /.col -->
          ...
          <div class="col-sm-4">
              <h1 class="m-0 text-white">Total Homme : <?php echo e(count($hommes)); ?><h1>
          </div><!-- /.col -->

        </div><!-- /.row -->

        <?php endif; ?>
        <?php if(Auth::user()->genre == "femme" and Auth::user()->isadmin !=1): ?>
        <div class="row mb-2">
          <div class="col-sm-4">
              <a href="<?php echo e(route('membre.create')); ?>" class="btn bubbly-button btn-lg"><i class="fa fa-plus"></i> Ajouter</a>
          </div><!-- /.col -->
