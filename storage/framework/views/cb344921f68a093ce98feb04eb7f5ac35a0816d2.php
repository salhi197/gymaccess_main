        ...
        <div class="container-fluid">
            <div class="card-header">
                ...
                <div class="row card1-group">
                    ...
                    <div class="col-md-1 text-center card1 blur">
                        <a style="padding:15px;" class="btn text-white" class="btn btn-primary" href="<?php echo e(route('produit.index')); ?>" ><i class="fa fa-box" style="font-size:40px;"></i></a>
            ...
            <div class="align-items-center timePM">
                ...
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <h2 class="text-white mb-1 font-weight-medium text-center" id="">
                        Utilisateur Connecté : <?php echo e(Auth::user()->name); ?>
                    ...
                    <div class="card-group">
                        <div class="card-body text-white" >
                            ...
                            <div class="row card1-group">
                                ...
                                <div class="card1">
                                      <div class="inner">
                                        <i class="fa fa-user-group" style="font-size:30px;">
