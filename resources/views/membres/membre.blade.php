                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                  ...
                                  <!--       <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h5 style="font-size:50px;
                                                font-family:'Orbitron', sans-serif !important;" class="text-white mb-1 font-weight-medium text-center" id="datefin">{{$inscription->fin}}</h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <h5 style="font-size:50px;
                                                font-family:'Orbitron', sans-serif !important;" class="text-white mb-1 font-weight-medium text-center" >{{$membre->getLastPresence() ?? ''}}</h5>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <h5 style="font-size:50px;
                                                font-family:'Orbitron', sans-serif !important;" class="text-white mb-1 font-weight-medium text-center" >{{$inscription->getAbonnement() ?? ''}}</h5>
                                            </div>
                                        </div>
