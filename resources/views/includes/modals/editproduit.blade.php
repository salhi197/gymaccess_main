            ...
            <div class="modal-body">
                <form action="{{route('produit.update',['produit'=>$produit->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $produit->nom ?? '' }}" name="nom2" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $produit->prix_achat ?? '' }}" name="prix_achat2" class="form-control" id=""
                            placeholder=" ">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Prix Vente : </label>
                        <input type="text" value="{{ $produit->prix_vente ?? '' }}" name="prix_vente2" class="form-control" id="prix_vente"
                            placeholder="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Qte : </label>
                        <input type="text" value="{{ old('qte') }}" name="qte2" class="form-control" id="qte"
                            placeholder="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" value="{{ $produit->photo ?? '' }}" name="photoedit2" class="form-control" id="photo"
                            placeholder="">
                    </div>
